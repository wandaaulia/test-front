  ...
  return (
    <div className="bg-black container-service text-white divide-y divide-white ">
      <div className="flex flex-row justify-start pb-20">
        <h1 className="mr-28 text-6xl break-normal text-left tracking-wide">
          {" "}
          OUR SERVICES{" "}
        </h1>
      ...
      <ul clasName="text-white">
        <li className="bottom-white flex flex-row justify-between pt-8 pb-5">
          <h5 className="text-lg text-title text-center">
            {" "}
        ...
        <li className="flex flex-row justify-between pt-8 pb-5">
          <div className="flex flex-col justify-between items-start width-43-custom">
            <h5 className="text-lg text-title font-bold text-center pt-1">
              {" "}
          ...
          <div className="flex flex-col width-55">
            ...
            <div className="flex flex-row mt-5 items-center justify-between pr-14">
              <div className="text-desc width-70 text-start">
                ...
                things. The team possesses unique individuality and strong
                qualifications and can easily translate something so abstract
                and visionary into a digital experience. They always put the
        ...
        {dataList.map((item) => {
          if (item.id === 4) {
            return (
              <li
                className=" flex flex-row justify-between pt-6 pb-0 items-center"
                key={item.id}
              >
                <h5 className="text-lg text-title-2 tracking-wider">
                  {" "}
                  {item.title}{" "}
                </h5>
          ...
          return (
            <li
              className="bottom-white flex flex-row justify-between pt-5 pb-5 items-center"
              key={item.id}
            >
              <h5 className="text-lg text-title-2 tracking-wider">
                {" "}
